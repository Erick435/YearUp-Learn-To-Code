...
function loadWinningTicketsTable() {
    let wTickets = winningTickets;
    for (let wTicket of wTickets){

        // these 2 lines of code does the same thing as the one below
        ...
        cell1.innerText = wTicket.tixNum;

        let cell2 = row.insertCell(1);
        cell2.innerText = "$" + wTicket.prize.toFixed(2);
